...
from circlecircle2.core.fea.lsdyna.keywords.database_sleout import DatabaseSleout


class DatabaseSleoutParser(Parser):
    def __init__(self):
        super().__init__()
    ...
    def _12p0(self, line_raw):
        ...
        uid = len(self.dataframe.database_sleout) + 1

        self.dataframe.database_sleout[uid] = DatabaseSleout(uid=uid,
                                                             dt=dt,
                                                             binary=binary,
                                                             lcur=lcur,
                                                             ioopt=ioopt, )
