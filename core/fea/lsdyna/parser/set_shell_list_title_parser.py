...
from circlecircle2.core.fea.lsdyna.keywords.set_shell_list import SetShellList


class SetShellListTitleParser(Parser):
    def __init__(self):
        super().__init__()
    ...
    def _12p0(self, line_raw):
        ...
        if self.line_number == 1:
            ...
            self.dataframe.set_shell_list[sid] = SetShellList(uid=sid,
                                                              da1=da1,
                                                              da2=da2,
                                                              da3=da3,
                                                              da4=da4,
        ...
        if self.line_number != 0 and self.line_number != 1:
            ...
            current_set_list_object = self.dataframe.set_shell_list[self.current_set_list_id]
