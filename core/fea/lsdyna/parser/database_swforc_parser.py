...
from circlecircle2.core.fea.lsdyna.keywords.database_swforc import DatabaseSwforc


class DatabaseSwforcParser(Parser):
    def __init__(self):
        super().__init__()
    ...
    def _12p0(self, line_raw):
        ...
        uid = len(self.dataframe.database_swforc) + 1

        self.dataframe.database_swforc[uid] = DatabaseSwforc(uid=uid,
                                                             dt=dt,
                                                             binary=binary,
                                                             lcur=lcur,
                                                             ioopt=ioopt, )
