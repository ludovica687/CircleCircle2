...
from circlecircle2.core.fea.lsdyna.keywords.database_jntforc import DatabaseJntforc


class DatabaseJntforcParser(Parser):
    def __init__(self):
        super().__init__()
    ...
    def _12p0(self, line_raw):
        ...
        uid = len(self.dataframe.database_jntforc) + 1

        self.dataframe.database_jntforc[uid] = DatabaseJntforc(uid=uid,
                                                               dt=dt,
                                                               binary=binary,
                                                               lcur=lcur,
                                                               ioopt=ioopt)
