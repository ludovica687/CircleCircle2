...
from circlecircle2.core.fea.lsdyna.keywords.database_rwforc import DatabaseRwforc


class DatabaseRwforcParser(Parser):
    def __init__(self):
        super().__init__()
    ...
    def _12p0(self, line_raw):
        ...
        uid = len(self.dataframe.database_rwforc) + 1

        self.dataframe.database_rwforc[uid] = DatabaseRwforc(uid=uid,
                                                             dt=dt,
                                                             binary=binary,
                                                             lcur=lcur,
                                                             ioopt=ioopt, )
