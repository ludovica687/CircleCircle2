...
from circlecircle2.core.fea.lsdyna.keywords.database_abstat import DatabaseAbstat


class DatabaseAbstatParser(Parser):
    def __init__(self):
        super().__init__()
    ...
    def _12p0(self, line_raw):
        ...
        uid = len(self.dataframe.database_abstat) + 1

        self.dataframe.database_abstat[uid] = DatabaseAbstat(uid=uid,
                                                             dt=dt,
                                                             binary=binary,
                                                             lcur=lcur,
                                                             ioopt=ioopt, )
