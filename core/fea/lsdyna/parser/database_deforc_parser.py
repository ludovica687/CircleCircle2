...
from circlecircle2.core.fea.lsdyna.keywords.database_deforc import DatabaseDeforc


class DatabaseDeforcParser(Parser):
    def __init__(self):
        super().__init__()
    ...
    def _12p0(self, line_raw):
        ...
        self.dataframe.database_deforc[uid] = DatabaseDeforc(uid=uid,
                                                             dt=dt,
                                                             binary=binary,
                                                             lcur=lcur,
                                                             ioopt=ioopt,)
